...
def sees_docs(customers=100, products=50):
    ...
    def customer_record():
        ...
        _record["acct_created"] = date.today() - timedelta(days = np.random.randint(1, company_age))
    ...
    def product_record():
        ...
        qualities = [center_type, chocolate_type, dietary, filling_type]
        ...
        def candy_name_generator():
            desc_start = ["mini", "gold", "cinnamon", "birthday", "butterscotch", "scotchmallow", 
                          "assorted", "double", "maple", "triple", "sour", "Fall",
                         "Spring", "Easter", "Summer", "Winter", "large", "tiny", "small", "medium",
                         "pink", "fancy"]
            desc_end = ["balls", "twists", "krispys", "bar", "brittle", "square", "JackOLanterns", 
                        "bundle", "bats", "leaves", "candies", "lollypop"]
            candy_name = ""
            if len(qualities)>1:
